            ...
            op.tableOption = {
                ...
                queryParams: {
                    where: JSON.stringify([{
                        ...
                        "field": "updated_at",
                        "compareSymbol": "gt",
                        "value": new Date(Date.now() - 86400000 * 1),
                        "rightBracket": "",
                        "logicalSymbol": "and",
                        "viewValue": null
                    }])
                ...
                pageSize: '5000',
                pageList: [5000, 10000, 50000, 100000],
            ...
            op.tableOption.columns = [
                [{
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            return Number.isNaN(Number.parseFloat(value)) ? '￥0.00' : '￥' + Number
