...
module.exports = app => {
   ...
   * 普通数据表对应的R-C结构
   */
  const tableControllers = ['user', 'menu', 'userType', 'card', 'cardRecharge', 'cardType', 'commodity', 'commodityType', 'commodityWarehousing', 'consumption', 'employee', 'employeeType', 'employeeWage', 'member', 'case'];
